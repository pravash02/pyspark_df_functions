# spark-submit standard_file_valid_fixedlen_text_file/stndrd_file_validtn.py

from pyspark.sql import SparkSession, SQLContext
from pyspark.sql.functions import *
from standard_file_valid_fixedlen_text_file.file_mthd import FileMethods


class SVLDJobFixedLen(FileMethods):
    def __init__(self):
        pass
    ...
    def transform_data(self, spark):
        super().read_header(spark, self.df_file_cntnt, header_filter="value like 'H%'",
                            input_file_dml='standard_file_valid_fixedlen_text_file/input_source_file_schema.json')
